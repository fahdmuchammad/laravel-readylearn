    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route("adminhome")}}">
            <div class="sidebar-brand-icon rotate-n-15">
                <i src={{asset('assets/images/logo.png')}}></i>
            </div>
            <div class="sidebar-brand-text mx-3">ReadyLearn</div>
        </a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="{{ route('admin.konfirmasi') }}">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Readylearn {{ now()->year }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
