...
class AuthController extends Controller
{
    ...
    public function postLogin(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            if ($cek == 1) {
                return redirect()
                    ->intended('adminhome')
                    ->withSuccess('Selamat datang di halaman admin');
            } else {
                return redirect()
                    ->intended('dashboard')
                    ->withSuccess('Selamat datang calon pemimpin bangsa');
            }
        }
    ...
    {
        $hapus = UserVerify::where('user_id', Auth::user()->id);
        $hapus->delete();
        $token = Str::random(64);
        UserVerify::create([
        ...
        Mail::send(
            ...
            function ($message) {
                ...
                $message->subject('Resend Email Verifikasi');
            }
        );
    ...
    public function verifyAccount($token)
    {
        ...
        $message = 'Token anda sudah tidak berlaku, verifikasi kembali';
